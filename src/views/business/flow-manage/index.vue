    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        >
          ...
          <el-table-column label="用车联系人"  prop="carLink" width="100" :show-overflow-tooltip="true" />
          <el-table-column label="行程"  prop="tripName" width="120" />
          <el-table-column label="车辆编号"  prop="carId" width="80" />
          <el-table-column label="司机姓名"  prop="driverName" width="80" />
          <el-table-column label="单位经办人"  prop="operatorName" width="100" :show-overflow-tooltip="true" />
        ...
        <el-dialog v-if="open" :title="title" :visible.sync="open" width="500px" :close-on-click-modal="false">
          <el-form class="add__form" ref="form" :model="form" :rules="rules" label-width="100px">
